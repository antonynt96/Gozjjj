...
<table width="1010" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td bgcolor="#FFFFFF"><table width="1000" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        <td><a href="https://web.facebook.com/profile.php?id=100009964182837" target="_blank"  rel="nofollow">
		<img style="border:none; width:100%; height:300px;" src="banner.jpg"/></a></td>
      </tr>
      <tr>
        ...
        <td class="style4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr valign="top">
              ...
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="center"><img src="banner.jpg" style="height:150px;width:100%;"/></td>
                  </tr>
                  <tr>
        ...
        <td class="style24"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr valign="top">
              ...
              <td bgcolor="#126eb1" class="style25"><strong>CÔNG TY CỔ PHẦN TRUYỀN THÔNG THẾ GIỚI PHẲNG </strong><br>
                ĐỊA CHỈ: 130 VŨ TÙNG - P2 - BÌNH THẠNH<br>
                Điện thoại: 0902 721 541</td>
